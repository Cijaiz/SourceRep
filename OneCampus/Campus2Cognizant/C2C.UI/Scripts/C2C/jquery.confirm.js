 ...
 */ (function (b) {
    ...
    b.modal.defaults = {
        ...
        overlayCss: {},
        containerId: "simplealert-container",
        containerCss: {},
    ...
    b.modal.impl = {
        ...
        create: function (a) {
            ...
            this.d.container = b("<div></div>").attr("id", this.o.containerId).addClass("simplealert-container").css(b.extend({
        ...
        watchTab: function (a) {
            if (0 < b(a.target).parents(".simplealert-container").length) {
