...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="NotificationHub.Cloud" generation="1" functional="0" release="0" Id="27430c34-7005-4315-b7d6-e0db768059bf" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="NotificationHub.CloudGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="NotificationHub" generation="1" functional="0" release="0" software="D:\GIT Repository\SourceRep\OneCampus\NotificationHub\NotificationHub.Cloud\csx\Debug\roles\NotificationHub" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="768" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="eab825a8-6b2e-4d41-a814-ba0732ae7f80" ref="Microsoft.RedDog.Contract\ServiceContract\NotificationHub.CloudContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="13dc3a7f-58f4-4e3c-ac6e-cb55c6be1f10" ref="Microsoft.RedDog.Contract\Interface\NotificationHub:HttpsIn@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/NotificationHub.Cloud/NotificationHub.CloudGroup/NotificationHub:HttpsIn" />
          </inPort>
        </interfaceReference>
